...
public class GroupCommentFeedListAdapter extends BaseAdapter {  
    ...
    public GroupCommentFeedListAdapter(Activity activity, List<GroupFeedComment> feedItems) {
    ...
    @Override
    public GroupFeedComment getItem(int location) {
...
//                .findViewById(R.id.feedImage1);
        ...
        final GroupFeedComment item = feedItems.get(position);
 ...
 profilePic.setOnClickListener( new OnClickListener() {
	...
	public void onClick(View v) {
	   ...
	   protected void showProfile(GroupFeedComment item) {
		// TODO Auto-generated method stub
	...
	public void remove(int location)
	   {
		GroupFeedComment comment = getItem(location);
		   if(comment!=null)
		   {

...
public class ChurchMembersList extends Fragment {
     public Integer justClicked=199;
	public ChurchMembersList() {
...
//       listAdapter.notifyDataSetChanged();
	...
	private static final String TAG = ChurchMembersList.class
			.getSimpleName();
		...
		justClicked=0;
			...
			StringRequest jsonReq = new StringRequest(Method.POST, URL_FEED,
				...
				protected Map<String, String> getParams() {
					...
					params.put("reason", "Load Church Members");
					return params;
				}
			};

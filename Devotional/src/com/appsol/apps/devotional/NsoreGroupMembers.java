...
public class NsoreGroupMembers extends ActionBarActivity {

	public NsoreGroupMembers() {
...
int count) {
		...
		listAdapter = new UsersFeedListAdapter(NsoreGroupMembers.this,android.R.layout.simple_list_item_1, feedItems,true);
		if(listView!=null)
		{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        GID="";
        String name= getIntent().getStringExtra("GN");
			...
			StringRequest jsonReq = new StringRequest(Method.POST, URL_FEED,
				...
				protected Map<String, String> getParams() {
					...
					params.put("UID", Connector.getUserId());
						...
						params.put("reason", "Load Group Members");
...
//					params.put("reason", "Load My Connections");
		...
		private Response.ErrorListener createMyReqErrorListener() {
			return new Response.ErrorListener() {
				...
				public void onErrorResponse(VolleyError error) {
					...
					if(error!=null)
					{
					showErrorDialog(Connector.HandleVolleyerror(error, NsoreGroupMembers.this));
	    ...
	    private void parseJsonFeed(String response) {
	    	...
	    	progressbarLoad.setVisibility(View.GONE);
	    	if (!response.trim()
					.contains("No request") &&!response.trim()

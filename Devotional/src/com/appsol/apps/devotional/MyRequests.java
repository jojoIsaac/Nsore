...
public class MyRequests extends ActionBarActivity {
...
int count) {
		...
		listAdapter = new UsersFeedListAdapter(MyRequests.this,android.R.layout.simple_list_item_1, feedItems,true);
		if(listView!=null)
		{
			...
			StringRequest jsonReq = new StringRequest(Method.POST, URL_FEED,
				...
				protected Map<String, String> getParams() {
					...
					params.put("UID", Connector.getUserId());
						...
						params.put("reason", "Load Connection Request");
		...
		private Response.ErrorListener createMyReqErrorListener() {
			return new Response.ErrorListener() {
				...
				public void onErrorResponse(VolleyError error) {
					...
					if(error!=null)
					{
					showErrorDialog(Connector.HandleVolleyerror(error,MyRequests.this));

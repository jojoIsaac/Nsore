...
public class DevotionDiscussions extends ActionBarActivity {
	private static String URL_FEED = "https://nsoredevotional.com/mobile/devotionHandler.php";
   
    private DevotionCommentFeedListAdapter listAdapter;
    private List<DevotionComment> feedItems;
	 private static final String TAG = DevotionDiscussions.class.getSimpleName();
	 ...
	 private boolean mHasData = false;
		...
		private void loadpage2()
	    {
	    	 ...
	    	 //https://nsoredevotional.com/mobile/eventsFetch.php?reason=Get%20Devotion%20lesson%20Comments&LID=118&index=1&MID=4
		        	URL_FEED= "https://nsoredevotional.com/mobile/devotionHandler.php?reason=?reason=Get%20Devotion%20lesson%20Comments&topicid="+devotionID+"&senderid="+Connector.getUserId();
		 		       ...
		 		       Map<String, String> params = new HashMap<String, String>();
		 		        	 params.put("LID", devotionID);
			 		            params.put("MID", Connector.getUserId());
				 		        	params.put("reason", "Get Devotion lesson Comments");
		 ...
		 private Response.ErrorListener createMyReqErrorListener() {
				return new Response.ErrorListener() {
					...
					public void onErrorResponse(VolleyError error) {
						...
						if(error!=null)
						{
						showErrorDialog(Connector.HandleVolleyerror(error, DevotionDiscussions.this),1);
...
//							mAdapter.notifyDataSetChanged();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.fragment_chat_ui);
...
//
	...
	private void setUpUI(Bundle savedInstanceState) {
		...
		devotionRawDate= getIntent().getStringExtra("rawdate");
		devotionID= getIntent().getExtras().getString("lesson_ID");
		devotionTitle= getIntent().getExtras().getString("title");
		devotionDay= getIntent().getExtras().getString("day");
		
		if (getIntent().getExtras().getString("lesson_ID")!= null && savedInstanceState==null) {
			devotionID= getIntent().getExtras().getString("lesson_ID");
		}
		//Set the Devotion Details
		LinearLayout lvDate = (LinearLayout) findViewById(R.id.lvDate);
		TextView txtdevotionTitle = (TextView) findViewById(R.id.txtdevotionTitle), txtDate = (TextView) 
				findViewById(R.id.txtdate), tvc = (TextView) 
		...
		txtDate.setText(devotionDate);
		// TextView tvc=(TextView) row.findViewById(R.id.txtday);
		tvc.setText(devotionDay);
		
		
		final ListView  
		 listView = (ListView)  findViewById(R.id.lv);
		 
	        feedItems = new ArrayList<DevotionComment >();
	 
	        listAdapter = new DevotionCommentFeedListAdapter(this, feedItems);
...
// 		            params.put("reason", "Members Testimonies");
	...
	protected void saveDataOnServer(final String newText) {
		...
		StringRequest jsonReq = new StringRequest(Method.POST,
                ...
                },  createMyReqErrorListener(2))
		 {
		        ...
		        protected Map<String, String> getParams() {
		         Map<String, String> params = new HashMap<String, String>();
		            params.put("reason", "Save devotion Comment");
	...
	private ErrorListener createMyReqErrorListener(final int i) {
		return new Response.ErrorListener() {
			...
			public void onErrorResponse(VolleyError error) {
				...
				if(error!=null)
				{
				showErrorDialog(Connector.HandleVolleyerror(error, DevotionDiscussions.this),i);
				if(error.getMessage()!=null)
				Log.d("RES", error.getMessage());
				}
				else
    ...
    private void parseJsonFeed(String response) {
        ...
        try {
			...
			if (objects != null) {
				JSONArray feedArray  = objects.getJSONArray("DevotionComment");
            ...
            for (int i = 0; i < feedArray.length(); i++) {
              ...
              DevotionComment  item = new DevotionComment();
              /*
               name memberID comment_id timeStamp comment profilePic
               * 
               */
              item.setLessonID(feedObj.getInt("lessonID")+"");
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
		...
		// TODO Auto-generated method stub
		DevotionComment devotion = null;
		if (v.getId() == R.id.lv) {
		    ListView lv = (ListView) v;
		    AdapterView.AdapterContextMenuInfo acmi = (AdapterContextMenuInfo) menuInfo;
		 devotion = (DevotionComment) lv.getItemAtPosition(acmi.position);
...
//		// TODO Auto-generated method stub
    ...
    void deleteFromServer(final DevotionComment comment,final Integer position)
    {
    	StringRequest jsonReq = new StringRequest(Method.POST,
                "https://nsoredevotional.com/mobile/devotionHandler.php", new Response.Listener<String>() {
                  ...
                  })
  		 {
  		        ...
  		        protected Map<String, String> getParams() {
  		         Map<String, String> params = new HashMap<String, String>();
  		            params.put("reason", "Delete Devotion Comment");
